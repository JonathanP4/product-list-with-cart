<script lang="ts">
	...
	export let showConfirmCard: boolean;
	export let newOrder: () => any;
...
>
	...
	<div
		class="flex justify-between items-center py-6 border border-transparent border-t-rose-100"
	>
		<span>Order total</span>
		<span class="text-3xl font-bold text-rose-950">
			{formatCurrency(totalPrice)}
		</span>
	</div>
	<Button onClick={newOrder} text={"Start New Order"} />
</div>
